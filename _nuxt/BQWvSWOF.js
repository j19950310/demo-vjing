const __vite__fileDeps=["./kV8m2cin.js","./rW_8XAkS.js","./error-404.JekaaCis.css","./B2LVe6h1.js","./error-500.CNP9nqm1.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
/**
* @vue/shared v3.4.27
...
`);const i=Number(n.statusCode||500),r=i===404,s=n.statusMessage??(r?"Page Not Found":"Internal Server Error"),o=n.message||n.toString(),a=void 0,c=r?Kc(()=>Ol(()=>import("./kV8m2cin.js"),__vite__mapDeps([0,1,2]),import.meta.url).then(f=>f.default||f)):Kc(()=>Ol(()=>import("./B2LVe6h1.js"),__vite__mapDeps([3,1,4]),import.meta.url).then(f=>f.default||f));return(f,h)=>(Rn(),rr(it(c),wm(Hd({statusCode:it(i),statusMessage:it(s),description:it(o),stack:it(a)})),null,16))}},bh={__name:"nuxt-root",setup(t){const e=()=>null,n=ct(),i=n.deferHydration();if(n.isHydrating){const a=n.hooks.hookOnce("app:error",i);Fn().beforeEach(a)}const r=!1;gr(Yo,lp()),n.hooks.callHookWith(a=>a.map(l=>l()),"vue:setup");const s=Ko();xd((a,l,u)=>{if(n.hooks.callHook("vue:error",a,l,u).catch(c=>console.error("[nuxt] Error in `vue:error` hook",c)),h0(a)&&(a.fatal||a.unhandled))return n.runWithContext(()=>ar(a)),!1});const o=!1;return(a,l)=>(Rn(),rr(ud,{onResolve:it(i)},{default:sd(()=>[it(s)?(Rn(),rr(it(Sw),{key:0,error:it(s)},null,8,["error"])):it(o)?(Rn(),rr(it(e),{key:1,context:it(o)},null,8,["context"])):it(r)?(Rn(),rr(gg(it(r)),{key:2})):(Rn(),rr(it(yw),{key:3}))]),_:1},8,["onResolve"]))}};let Ah;{let t;Ah=async function(){var o,a;if(t)return t;const i=!!((o=window.__NUXT__)!=null&&o.serverRendered||((a=document.getElementById("__NUXT_DATA__"))==null?void 0:a.dataset.ssr)==="true")?W_(bh):G_(bh),r=Kv({vueApp:i});async function s(l){await r.callHook("app:error",l),r.payload.error=r.payload.error||Zo(l)}i.config.errorHandler=s;try{await Jv(r,Ny)}catch(l){s(l)}try{await r.hooks.callHook("app:created",i),await r.hooks.callHook("app:beforeMount",i),i.mount(ix),await r.hooks.callHook("app:mounted",i),await ps()}catch(l){s(l)}return i.config.errorHandler===s&&(i.config.errorHandler=void 0),i},t=Ah().catch(e=>{throw console.error("Error while mounting app:",e),e})}export{sd as A,kd as B,Ew as C,Tw as D,Rw as E,Aw as F,si as G,Ig as H,Lg as I,Rl as J,uc as K,lp as L,_w as _,Dp as a,rf as b,an as c,ms as d,$o as e,Pw as f,In as g,Hi as h,bw as i,mc as j,av as k,vc as l,ct as m,Cw as n,qo as o,jo as p,ww as q,st as r,pc as s,Rn as t,Fn as u,Fd as v,Sl as w,lc as x,Mw as y,lt as z};
